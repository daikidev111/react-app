...
export default class EditMovie extends Component {
    ...
    // this is to bind the change with the prevState so that it updates everytime the value changes
    handleChange = (event) => {
            ...
            return (
                <Fragment>
                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <Input
                            title={"Title"}
                            className={this.hasError("title") ? "is-valid" : ""}
                            type={"text"}
                            name={"title"}
                            value={movie.title}
                            handleChange={this.handleChange}
                            errorDiv ={this.hasError("title") ? "text-danger" : "d-none"}
                            errorMsg = {"Please input a title"}
                        />
