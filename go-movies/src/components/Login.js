    ...
    fetch("http://localhost:4000/v1/signin", requestOptions)
        ...
        .then((data) => {
            if (data.error) {
                ...
                //   {
                //     "jwt": {
                //        "reponse": ""
                //     }
                //  }
